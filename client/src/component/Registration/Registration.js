...
import Election from "C:/Users/ksr/Desktop/vikrant/try_another/dVoting/client/src/contracts/Election.json";
                  ...
                  <div className="div-li">
                    <label className={"label-r"}>
                      ...
                      <input
                        ...
                        type="text"
                        placeholder="eg. Ava"
                        value={this.state.voterName || "abc"}
                  ...
                  <div className="div-li">
                    <label className={"label-r"}>
                      ...
                      <input
                        ...
                        value={this.state.voterPhone || "9841234567"}
